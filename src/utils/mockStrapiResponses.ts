...
export const about = {
  "data": {
    "id": 1,
    "attributes": {
      "design": "Background on design, mention Brandon Lemus design here to give credit",
      "tech": "Tech Stack",
      "goals": "Goals and underlying tech reasoning here (CMS ready, etc)",
